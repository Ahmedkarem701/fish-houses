                        ...
                        <div class="modal-dialog modal-lg">
                          <div class="modal-content">
                            ...
                            <div style="text-align: left" class="modal-body">
                              <form class="form theme-form" action="backend/insert.php?do=categories" method="post">
                                <div class="row mb-3">
                                  <div class="col">
                                    <div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <button class="btn btn-danger" onclick="window.location.href='backend/delete.php?do=categories&id=<?php echo $category['id'];?>'">Delete</button>
                                </div>
                            </td>
                        </tr>
                      <?php }?>
