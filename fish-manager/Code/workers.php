<?php
    ...
    if (!isset($_SESSION['login']['email']))
        header('Location: ../../fish-website/login.php');


$sql = $con->prepare('select * from users where user_type = 1');
    $sql->execute();
            ...
            <div class="page-title">
              <div class="row">
                <div class="col-12 col-sm-6">
                  <h3 style="text-align: left">Workers Users</h3>
                </div>
                <div class="col-12 col-sm-6">
                  <p class="breadcrumb">
                    <button class="btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target=".bd-example-modal-lg">Add Profile</button>
                      ...
                      <div class="modal-content">
                        <div class="modal-header">
                          ...
                          <div style="text-align: left" class="modal-body">
                              <form class="form theme-form" method="post" action="backend/insert.php?do=worker" enctype="multipart/form-data">
                                  <div class="row mb-3">
                                      <div class="col">
                                          <div>
                                  ...
                                  <div class="row mb-3">
                                      <div class="col">
                                          <div>
                                              ...
                                              <select class="form-control btn-square" name="jop" required>
                                  ...
                                  <div class="row mb-3">
                                      <div class="col">
                                          <div>
                                              ...
                                              <select class="form-control btn-square" name="dept" required>
                                                  <option value="">Select One Value Only</option>
              ...
              <?php foreach ($workers as $worker) {?>
                <div class="col-md-6 col-lg-6 col-xl-4 box-col-4">
                    <div class="card custom-card">
                        ...
                        <div class="card-profile"><img class="rounded-circle" src="<?php echo $base_url . $worker['photo'];?>" alt=""></div>
                        <div class="text-center profile-details"><a href="#">
                                <h4><?php echo $worker['name'];?></h4></a>
                            <h6>Worker</h6>
                        </div>
                        <div class="card-footer row">
                            <div class="col-6 col-sm-6">
                                <button style="width: 100%" class="btn btn-primary" type="button" data-bs-toggle="modal" data-original-title="test" data-bs-target="#exampleModal<?php echo $worker['id'];?>">Edit</button>
                            </div>
                            <div class="col-6 col-sm-6">
                                <button style="width: 100%" onclick="window.location.href = 'backend/delete.php?do=workers&id=<?php echo $worker['id'];?>'" class="btn btn-danger">Delete</button>
                            </div>
                        </div>
                    </div>

                    <div class="modal fade" id="exampleModal<?php echo $worker['id'];?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                ...
                                <div style="text-align: left" class="modal-body">
                                    <form class="form theme-form" method="post" action="backend/update.php?do=worker" enctype="multipart/form-data">
                                        <input type="hidden" name="id" value="<?php echo $worker['id'];?>">
                                        <div class="row mb-3">
                                            <div class="col">
                                                <div>
                                                    <label class="form-label">Profile Images</label>
                                                    <input class="form-control" type="file" name="photo" value="<?php echo $worker['photo'];?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <div class="col">
                                                <div>
                                                    <label class="form-label">Profile Name</label>
                                                    <input class="form-control" type="text" name="name" value="<?php echo $worker['name'];?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <div class="col">
                                                <div>
                                                    ...
                                                    <select class="form-control btn-square" name="jop" required>
                                                        <option value="">Select One Value Only</option>
                                                        <option <?php if ($worker['jop'] == 'Manager') echo 'selected';?> value="Manager">Manager</option>
                                                        <option <?php if ($worker['jop'] == 'Worker') echo 'selected';?> value="Worker">Worker</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <div class="col">
                                                <div>
                                                    ...
                                                    <select class="form-control btn-square" name="dept" required>
                                                        <option value="">Select One Value Only</option>
                                                        <option <?php if ($worker['dept'] == 'Selling') echo 'selected';?> value="Selling">Selling</option>
                                                        <option <?php if ($worker['dept'] == 'Cooking') echo 'selected';?> value="Cooking">Cooking</option>
                                                        <option <?php if ($worker['dept'] == 'Delivery') echo 'selected';?> value="Delivery">Delivery</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <div class="col">
                                                <div>
                                                    <label class="form-label">Profile Email</label>
                                                    <input class="form-control" type="email" name="email" value="<?php echo $worker['email'];?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="modal-footer">
          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-md-12 footer-copyright text-center">
                <p class="mb-0">Copyright 2022 © Fish house </p>
              </div>
            </div>
          </div>
        </footer>
