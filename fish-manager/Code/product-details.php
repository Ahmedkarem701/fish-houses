          ...
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                ...
                <div class="col-12 col-sm-6">
                  <p class="breadcrumb">
                    <button class="btn btn-primary m-r-20" type="button" data-bs-toggle="modal" data-bs-target=".bd-example-modal-lg">Edit Product</button>
                    <button class="btn btn-danger" type="button" onclick="window.location.href='backend/delete.php?do=products&id=<?php echo $single_product['id'];?>'">Delete</button>
                    ...
                    <div class="modal-dialog modal-lg">
                      <div class="modal-content">
                        ...
                        <div style="text-align: left" class="modal-body">
                          <form class="form theme-form" method="post" action="backend/update.php?do=products&id=<?php echo $single_product['id'];?>">
                              <input type="hidden" name="id" value="<?php echo $single_product['id'];?>">
                            <div class="row mb-3">
                              <div class="col">
                                <div>
                                  <label class="form-label">Product Name</label>
                                  <input class="form-control" type="text" name="name" value="<?php echo $single_product['p_name'];?>">
                                </div>
                              </div>
                            </div>
                            <div class="row mb-3">
                              <div class="col">
                                <div>
                                  ...
                                  <select class="form-control btn-square" name="cat">
                                      <option value="opt1">Select One Value Only</option>
                                      <?php foreach ($categories as $category) {?>
                                          <option <?php if ($category['id'] == $single_product['id']) echo 'selected';?> value="<?php echo $category['id'];?>"><?php echo $category['c_name'];?></option>
                                      <?php }?>
                                  </select>
                                </div>
                              </div>
                            ...
                            <div class="row mb-3">
                              <div class="col">
                                <div>
                                  ...
                                  <input class="form-control" type="number" name="price" value="<?php echo $single_product['p_price'];?>">
                                </div>
                              </div>
                            </div>
                            <div class="row mb-3">
                              <div class="col">
                                <div>
                                  ...
                                  <textarea class="form-control" id="exampleFormControlTextarea4" rows="3" name="desc"><?php echo $single_product['p_desc'];?></textarea>
                                </div>
                              </div>
                            </div>
          ...
          <div class="container-fluid">
            <div>
              <div class="row product-page-main p-0">
                <div class="col-xl-6 col-md-6 box-col-6 xl-50">
                  <div class="card">
                    <div class="card-body">
                      <div class="row">
                        <div class="col-xl-9 box-col-7 product-main">
                          <div class="pro-slide-single">
                              ...
                              <?php foreach ($products as $product) {?>
                                  ...
                                  <div><img class="img-fluid" src="<?php echo $base_url . $product['photo'];?>" alt=""></div>
                        ...
                        <div class="col-xl-3 box-col-4 product-thumbnail">
                          <div class="pro-slide-right">
                              <?php foreach ($products as $product) {?>
                                  ...
                                  <div>
                                      <div class="slide-box"><img src="<?php echo $base_url . $product['photo'];?>" alt=""></div>
                                  </div>
                    ...
                    <div class="card-body">
                      <div class="pro-group pt-0 border-0">
                        <div class="product-page-details mt-0">
                          <h3><?php echo $single_product['p_name'];?></h3>
                        </div>
                        <div class="product-price"><?php echo $single_product['p_price'];?>$</div>
                      </div>
                      <div class="pro-group">
                        <p><?php echo $single_product['p_desc'];?></p>
                      </div>
                    </div>
                  </div>
                </div>
