          ...
          <div class="container-fluid">        
            <div class="page-title">
              <div class="row">
                ...
                <div class="col-12 col-sm-6">
                  <p class="breadcrumb">
                    <button class="btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target=".bd-example-modal-lg">Add Product</button>
                    ...
                    <div class="modal-dialog modal-lg">
                      <div class="modal-content">
                        ...
                        <div style="text-align: left" class="modal-body">
                          <form class="form theme-form" method="post" action="backend/insert.php?do=products" enctype="multipart/form-data">
                            <div class="row mb-3">
                              <div class="col">
                                <div>
                        ...
                        <div class="col-xl-3 col-sm-12 xl-3">
                            <div class="card">
                                <div class="product-box">
                                    <div class="product-img"><img class="img-fluid" src="<?php echo $base_url . $photo['photo'];?>" alt=""></div>
                                    <div class="product-details">
                                        <a href="product-details.php?id=<?php echo $product['id'];?>"><h4><?php echo $product['p_name'];?></h4></a>
                                        <div class="product-price"><?php echo $product['p_price'];?>$</div>
                                    </div>
                                </div>
                            </div>
                        </div>
          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-md-12 footer-copyright text-center">
                <p class="mb-0">Copyright 2022 © FISH  </p>
              </div>
            </div>
          </div>
        </footer>
