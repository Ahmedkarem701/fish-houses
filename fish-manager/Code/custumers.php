...
$sql = $con->prepare('select * from users where user_type = 0');
$sql->execute();
$users = $sql->fetchAll();
?>
            ...
            <div class="page-title">
              <div class="row">
                <div class="col-12 col-sm-6">
                  <h3 style="text-align: left">Customers</h3>
                </div>
                <div class="col-12 col-sm-6">
                </div>
              </div>
                        ...
                        <div class="card custom-card">
                            ...
                            <div class="card-footer row">
                                <div class="col-12 col-sm-12">
                                    <button style="width: 100%" class="btn btn-danger" onclick="window.location.href='backend/delete.php?do=custumers&id=<?php echo $user['id'];?>'">Delete</button>
                                </div>
                            </div>
                        </div>
                    </div>
