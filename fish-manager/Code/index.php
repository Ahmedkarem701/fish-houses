                      ...
                      <div class="card">
                        <div class="blog-box blog-shadow"><img class="img-fluid bg-img-cover" src="../assets/images/blog/blog.jpg" alt="">
                          <div class="blog-details">
                            <p>1 April 2022</p>
                            <h4>Workers</h4>
                            <button onclick="window.location.href='workers.php'" class="btn btn-primary mb-3">Enter</button>
                      ...
                      <div class="card">
                        <div class="blog-box blog-shadow"><img class="img-fluid bg-img-cover" src="../assets/images/blog/blog.jpg" alt="">
                          <div class="blog-details">
                            <p>1 April 2022</p>
                            <h4>Custumers</h4>
                            <button onclick="window.location.href='custumers.php'" class="btn btn-primary mb-3">Enter</button>
                            <ul class="blog-social">
                              <li>5 users</li>
                            </ul>
                          </div>
