...
<head>
    ...
    <title>Fish house | Department </title>
    <!-- Google font-->
                                ...
                                <table class="table">
                                    ...
                                    <?php foreach ($requests as $request) {?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button class="btn btn-success mb-3" <?php if ($request['status'] == 0) echo 'onclick="window.location.href=\'../active.php?id=' . $request['r_id'] . '\'">Done'; else echo 'disabled>Done Mission'; ?></button>
                                            </td>
                                        </tr>
